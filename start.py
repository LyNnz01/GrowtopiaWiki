...
try:
	import subprocess
	subprocess.Popen([r"GrowtopiaWiki.exe"])
except:
	print("GrowtopiaWiki.exe not found? Move all files to same directory and relaunch or launch GrowtopiaWiki.exe manually.")
import sys
httpd=None
try:
